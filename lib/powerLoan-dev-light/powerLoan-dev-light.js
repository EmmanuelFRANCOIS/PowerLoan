...
_defineProperty(SimpleLoan, "defaultSimpleLoan", {
  ...
  createdAt: dayjs__WEBPACK_IMPORTED_MODULE_0___default()().format('YYYY-MM-DDTHH:mm:ssZ'),
  modifiedAt: dayjs__WEBPACK_IMPORTED_MODULE_0___default()().format('YYYY-MM-DDTHH:mm:ssZ')
});
